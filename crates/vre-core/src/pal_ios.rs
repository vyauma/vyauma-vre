...
impl PlatformAbstractionLayer for IosPal {
    ...
    fn tcp_connect(&self, _addr: &str) -> Result<TcpStream, String> { Err("iOS: Not implemented".into()) }
    fn tcp_bind(&self, _addr: &str) -> Result<TcpListener, String> { Err("iOS: Not implemented".into()) }
